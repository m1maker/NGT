...
const int AS_SDLK_AUDIONEXT = SDL_SCANCODE_AUDIONEXT;
const int AS_SDLK_AUDIOPREV = SDL_SCANCODE_AUDIOPREV;
const int AS_SDLK_AUDIOSTOP = SDL_SCANCODE_AUDIOSTOP;
const int AS_SDLK_AUDIOPLAY = SDL_SCANCODE_AUDIOPLAY;
const int AS_SDLK_AUDIOMUTE = SDL_SCANCODE_AUDIOMUTE;
const int AS_SDLK_MEDIASELECT = SDL_SCANCODE_MEDIASELECT;
const int AS_SDLK_WWW = SDL_SCANCODE_WWW;
const int AS_SDLK_MAIL = SDL_SCANCODE_MAIL;
const int AS_SDLK_CALCULATOR = SDL_SCANCODE_CALCULATOR;
const int AS_SDLK_COMPUTER = SDL_SCANCODE_COMPUTER;
...
const int AS_SDLK_BRIGHTNESSDOWN = SDL_SCANCODE_BRIGHTNESSDOWN;
const int AS_SDLK_BRIGHTNESSUP = SDL_SCANCODE_BRIGHTNESSUP;
const int AS_SDLK_DISPLAYSWITCH = SDL_SCANCODE_DISPLAYSWITCH;
const int AS_SDLK_KBDILLUMTOGGLE = SDL_SCANCODE_KBDILLUMTOGGLE;
const int AS_SDLK_KBDILLUMDOWN = SDL_SCANCODE_KBDILLUMDOWN;
const int AS_SDLK_KBDILLUMUP = SDL_SCANCODE_KBDILLUMUP;
const int AS_SDLK_EJECT = SDL_SCANCODE_EJECT;
...
void RegisterFunctions(asIScriptEngine* engine)
{
    ...
    engine->RegisterObjectMethod("library", "dictionary@ call(const string&in, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null, ?&in=null)const", asFUNCTION(library_call), asCALL_GENERIC);
