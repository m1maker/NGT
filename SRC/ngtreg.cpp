...
void RegisterFunctions(asIScriptEngine* engine)
{
	...
	engine->RegisterGlobalFunction("bool show_window(const string &in title, int width = 640, int height = 480, bool enable_renderer = true)", asFUNCTION(show_window), asCALL_CDECL);
